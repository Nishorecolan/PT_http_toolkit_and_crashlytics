...
void main() {
  ...
  /////////////// Performance testing related code  ///////////////

  // Set up HttpOverrides
  //HttpOverrides.global = MyHttpOverrides();

  // Use a global key to obtain a context
            ...
            TextButton(
              ...
              onPressed: () {
               ...
               // getOAuth2ProxyClient();
                  ...
                  //HttpOverrides.global = MyHttpOverrides(textEditingController.text);
                  HttpOverrides.global = MyHttpOverrides(textEditingController.text);
                   Navigator.of(context).pop();
              },
            ),
      ...
      body: Center(
        child: Column(
          children: [
            ...
            Column(
              children: [
                Text('Crashlytics',style: TextStyle(fontSize: 20,fontWeight: FontWeight.w500),),
                ElevatedButton(onPressed: ((){
                  print('Crashed...');
                  sleep(const Duration(seconds: 3));
                  FirebaseCrashlytics.instance.crash();
                }), child: Text('Click to crash'))
              ],
            ),
            SizedBox(height: 50,),
            Column(
              ...
              children: <Widget>[
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    labelText: "Text Input Action Done",
                  ),
                ),
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                String dynamicProxyIp = "192.168.20.92";
               //MyHttpOverrides(textEditingController.text)..findProxy('');
                setState(() {
                  //HttpOverrides.global = MyHttpOverrides(textEditingController.text);
                  HttpOverrides.global = MyHttpOverrides(dynamicProxyIp);
                });

                //HttpOverrides.global = MyHttpOverrides(textEditingController.text).createHttpClient(context)..findProxy('') as HttpOverrides?;
